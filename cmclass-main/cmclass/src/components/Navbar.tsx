...
import { useBrand } from '../../admin/context/BrandContext';
export const Navbar = () => {
 ...
 <div className="flex items-center justify-between">
          ...
          <div
            className={`mx-auto w-24 h-24 flex items-center justify-center bg-gray-100 text-gray-600 font-bold rounded ${
