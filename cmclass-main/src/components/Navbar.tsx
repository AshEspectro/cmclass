...
export const Navbar = () => {
    ...
    return (
        <>
            <motion.nav
                className={`fixed top-0 left-0 border-b border-black/5 right-0 z-30 transition-all duration-300 ${isScrolled
            ...
            ><div className="max-w-[1440px] mx-auto w-full overflow-x-hidden px-4 sm:px-6 lg:px-12 bg-white">
                    <div className="flex items-center justify-between">
                        ...
                        <Link to="/home" className="absolute left-1/2 -translate-x-1/2  justify-center">
                            <motion.div
                                className={`text-center transition-transform duration-300 align-middle   ${isScrolled ? 'scale-30' : 'scale-30'
                                    }`}
                            >
                                {brandLogo && (
                                    <img
